...
40000024:	e8 87 02 00 00       	call   400002b0 <printf>
...
40000029:	59                   	pop    %ecx
4000002a:	58                   	pop    %eax
4000002b:	68 e8 03 00 00       	push   $0x3e8
40000030:	6a 04                	push   $0x4
...
40000042:	8d 83 9a e1 ff ff    	lea    -0x1e66(%ebx),%eax
40000048:	50                   	push   %eax
40000049:	e8 62 02 00 00       	call   400002b0 <printf>
...
40000060:	8d 83 b1 e1 ff ff    	lea    -0x1e4f(%ebx),%eax
40000066:	50                   	push   %eax
40000067:	e8 44 02 00 00       	call   400002b0 <printf>
...
40000357:	e8 84 0d 00 00       	call   400010e0 <__umoddi3>
...
40000395:	e8 26 0c 00 00       	call   40000fc0 <__udivdi3>
...
40000839:	e8 f2 02 00 00       	call   40000b30 <strnlen>
...
400008b0:	e8 7b 02 00 00       	call   40000b30 <strnlen>
...
40000aa4:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
40000aaa:	c3                   	ret    
40000aab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000aaf:	90                   	nop
...
40000ab4:	b8 01 00 00 00       	mov    $0x1,%eax
40000ab9:	f0 87 02             	lock xchg %eax,(%edx)
    while (xchg(lk, 1) != 0)
40000abc:	85 c0                	test   %eax,%eax
40000abe:	74 13                	je     40000ad3 <spinlock_acquire+0x23>
    asm volatile ("lock; xchgl %0, %1"
40000ac0:	b9 01 00 00 00       	mov    $0x1,%ecx
40000ac5:	8d 76 00             	lea    0x0(%esi),%esi
        asm volatile ("pause");
40000ac8:	f3 90                	pause  
    asm volatile ("lock; xchgl %0, %1"
40000aca:	89 c8                	mov    %ecx,%eax
40000acc:	f0 87 02             	lock xchg %eax,(%edx)
    while (xchg(lk, 1) != 0)
40000acf:	85 c0                	test   %eax,%eax
40000ad1:	75 f5                	jne    40000ac8 <spinlock_acquire+0x18>
}
40000ad3:	c3                   	ret    
40000ad4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000adb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000adf:	90                   	nop
...
{
    return *lk;
40000ae4:	8b 02                	mov    (%edx),%eax
    if (spinlock_holding(lk) == FALSE)
40000ae6:	84 c0                	test   %al,%al
40000ae8:	74 05                	je     40000aef <spinlock_release+0xf>
    asm volatile ("lock; xchgl %0, %1"
40000aea:	31 c0                	xor    %eax,%eax
40000aec:	f0 87 02             	lock xchg %eax,(%edx)
}
40000aef:	c3                   	ret    

40000af0 <spinlock_holding>:
    return *lk;
40000af0:	8b 44 24 04          	mov    0x4(%esp),%eax
40000af4:	8b 00                	mov    (%eax),%eax
}
40000af6:	c3                   	ret    
40000af7:	66 90                	xchg   %ax,%ax
40000af9:	66 90                	xchg   %ax,%ax
40000afb:	66 90                	xchg   %ax,%ax
40000afd:	66 90                	xchg   %ax,%ax
40000aff:	90                   	nop
...
40000b00:	8b 54 24 04          	mov    0x4(%esp),%edx
    ...
    for (n = 0; *s != '\0'; s++)
40000b04:	31 c0                	xor    %eax,%eax
40000b06:	80 3a 00             	cmpb   $0x0,(%edx)
40000b09:	74 15                	je     40000b20 <strlen+0x20>
40000b0b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000b0f:	90                   	nop
        n++;
...
40000b19:	c3                   	ret    
40000b1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return n;
}
40000b20:	c3                   	ret    
40000b21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000b28:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000b2f:	90                   	nop
...
{
40000b30:	8b 54 24 08          	mov    0x8(%esp),%edx
40000b34:	8b 4c 24 04          	mov    0x4(%esp),%ecx
    int n;

    for (n = 0; size > 0 && *s != '\0'; s++, size--)
40000b38:	31 c0                	xor    %eax,%eax
40000b3a:	85 d2                	test   %edx,%edx
40000b3c:	75 09                	jne    40000b47 <strnlen+0x17>
40000b3e:	eb 10                	jmp    40000b50 <strnlen+0x20>
        n++;
40000b40:	83 c0 01             	add    $0x1,%eax
    for (n = 0; size > 0 && *s != '\0'; s++, size--)
40000b43:	39 d0                	cmp    %edx,%eax
40000b45:	74 09                	je     40000b50 <strnlen+0x20>
40000b47:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
40000b4b:	75 f3                	jne    40000b40 <strnlen+0x10>
40000b4d:	c3                   	ret    
...
40000b61:	8b 4c 24 08          	mov    0x8(%esp),%ecx
    char *ret;

    ret = dst;
    while ((*dst++ = *src++) != '\0')
40000b65:	31 c0                	xor    %eax,%eax
{
40000b67:	8b 5c 24 0c          	mov    0xc(%esp),%ebx
40000b6b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000b6f:	90                   	nop
    while ((*dst++ = *src++) != '\0')
40000b70:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
40000b74:	88 14 01             	mov    %dl,(%ecx,%eax,1)
40000b77:	83 c0 01             	add    $0x1,%eax
40000b7a:	84 d2                	test   %dl,%dl
40000b7c:	75 f2                	jne    40000b70 <strcpy+0x10>
        /* do nothing */ ;
    return ret;
}
40000b7e:	89 c8                	mov    %ecx,%eax
40000b80:	5b                   	pop    %ebx
40000b81:	c3                   	ret    
40000b82:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000b89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

40000b90 <strncpy>:

char *strncpy(char *dst, const char *src, size_t size)
{
40000b90:	56                   	push   %esi
40000b91:	53                   	push   %ebx
40000b92:	8b 5c 24 14          	mov    0x14(%esp),%ebx
40000b96:	8b 74 24 0c          	mov    0xc(%esp),%esi
40000b9a:	8b 54 24 10          	mov    0x10(%esp),%edx
    size_t i;
    char *ret;

    ret = dst;
    for (i = 0; i < size; i++) {
40000b9e:	85 db                	test   %ebx,%ebx
40000ba0:	74 21                	je     40000bc3 <strncpy+0x33>
40000ba2:	01 f3                	add    %esi,%ebx
40000ba4:	89 f0                	mov    %esi,%eax
40000ba6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000bad:	8d 76 00             	lea    0x0(%esi),%esi
        *dst++ = *src;
40000bb0:	0f b6 0a             	movzbl (%edx),%ecx
40000bb3:	83 c0 01             	add    $0x1,%eax
        // If strlen(src) < size, null-pad 'dst' out to 'size' chars
        if (*src != '\0')
            src++;
40000bb6:	80 f9 01             	cmp    $0x1,%cl
        *dst++ = *src;
40000bb9:	88 48 ff             	mov    %cl,-0x1(%eax)
            src++;
40000bbc:	83 da ff             	sbb    $0xffffffff,%edx
    for (i = 0; i < size; i++) {
40000bbf:	39 d8                	cmp    %ebx,%eax
40000bc1:	75 ed                	jne    40000bb0 <strncpy+0x20>
    }
    return ret;
}
40000bc3:	89 f0                	mov    %esi,%eax
40000bc5:	5b                   	pop    %ebx
40000bc6:	5e                   	pop    %esi
40000bc7:	c3                   	ret    
...
40000bd1:	8b 44 24 10          	mov    0x10(%esp),%eax
40000bd5:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
    char *dst_in;

    dst_in = dst;
    if (size > 0) {
40000bd9:	85 c0                	test   %eax,%eax
40000bdb:	74 30                	je     40000c0d <strlcpy+0x3d>
        while (--size > 0 && *src != '\0')
40000bdd:	8b 54 24 08          	mov    0x8(%esp),%edx
40000be1:	83 e8 01             	sub    $0x1,%eax
40000be4:	74 24                	je     40000c0a <strlcpy+0x3a>
40000be6:	01 d0                	add    %edx,%eax
40000be8:	89 c3                	mov    %eax,%ebx
40000bea:	eb 11                	jmp    40000bfd <strlcpy+0x2d>
40000bec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            *dst++ = *src++;
40000bf0:	83 c2 01             	add    $0x1,%edx
40000bf3:	83 c1 01             	add    $0x1,%ecx
40000bf6:	88 42 ff             	mov    %al,-0x1(%edx)
        while (--size > 0 && *src != '\0')
40000bf9:	39 da                	cmp    %ebx,%edx
40000bfb:	74 07                	je     40000c04 <strlcpy+0x34>
40000bfd:	0f b6 01             	movzbl (%ecx),%eax
40000c00:	84 c0                	test   %al,%al
40000c02:	75 ec                	jne    40000bf0 <strlcpy+0x20>
        *dst = '\0';
    }
    return dst - dst_in;
40000c04:	89 d0                	mov    %edx,%eax
40000c06:	2b 44 24 08          	sub    0x8(%esp),%eax
        *dst = '\0';
40000c0a:	c6 02 00             	movb   $0x0,(%edx)
}
40000c0d:	5b                   	pop    %ebx
40000c0e:	c3                   	ret    
40000c0f:	90                   	nop
...
40000c11:	8b 54 24 08          	mov    0x8(%esp),%edx
40000c15:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
    while (*p && *p == *q)
40000c19:	0f b6 02             	movzbl (%edx),%eax
40000c1c:	84 c0                	test   %al,%al
40000c1e:	75 18                	jne    40000c38 <strcmp+0x28>
40000c20:	eb 30                	jmp    40000c52 <strcmp+0x42>
40000c22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000c28:	0f b6 42 01          	movzbl 0x1(%edx),%eax
        p++, q++;
40000c2c:	83 c2 01             	add    $0x1,%edx
40000c2f:	8d 59 01             	lea    0x1(%ecx),%ebx
    while (*p && *p == *q)
40000c32:	84 c0                	test   %al,%al
40000c34:	74 12                	je     40000c48 <strcmp+0x38>
        p++, q++;
40000c36:	89 d9                	mov    %ebx,%ecx
    while (*p && *p == *q)
40000c38:	0f b6 19             	movzbl (%ecx),%ebx
40000c3b:	38 c3                	cmp    %al,%bl
40000c3d:	74 e9                	je     40000c28 <strcmp+0x18>
    return (int) ((unsigned char) *p - (unsigned char) *q);
40000c3f:	29 d8                	sub    %ebx,%eax
}
40000c41:	5b                   	pop    %ebx
40000c42:	c3                   	ret    
40000c43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000c47:	90                   	nop
    return (int) ((unsigned char) *p - (unsigned char) *q);
40000c48:	0f b6 59 01          	movzbl 0x1(%ecx),%ebx
40000c4c:	31 c0                	xor    %eax,%eax
40000c4e:	29 d8                	sub    %ebx,%eax
}
40000c50:	5b                   	pop    %ebx
40000c51:	c3                   	ret    
    return (int) ((unsigned char) *p - (unsigned char) *q);
40000c52:	0f b6 19             	movzbl (%ecx),%ebx
40000c55:	31 c0                	xor    %eax,%eax
40000c57:	eb e6                	jmp    40000c3f <strcmp+0x2f>
40000c59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
40000c62:	8b 74 24 14          	mov    0x14(%esp),%esi
40000c66:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
40000c6a:	8b 44 24 10          	mov    0x10(%esp),%eax
    while (n > 0 && *p && *p == *q)
40000c6e:	85 f6                	test   %esi,%esi
40000c70:	74 2e                	je     40000ca0 <strncmp+0x40>
40000c72:	01 c6                	add    %eax,%esi
40000c74:	eb 18                	jmp    40000c8e <strncmp+0x2e>
40000c76:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000c7d:	8d 76 00             	lea    0x0(%esi),%esi
40000c80:	38 da                	cmp    %bl,%dl
40000c82:	75 14                	jne    40000c98 <strncmp+0x38>
        n--, p++, q++;
40000c84:	83 c0 01             	add    $0x1,%eax
40000c87:	83 c1 01             	add    $0x1,%ecx
    while (n > 0 && *p && *p == *q)
40000c8a:	39 f0                	cmp    %esi,%eax
40000c8c:	74 12                	je     40000ca0 <strncmp+0x40>
40000c8e:	0f b6 11             	movzbl (%ecx),%edx
40000c91:	0f b6 18             	movzbl (%eax),%ebx
40000c94:	84 d2                	test   %dl,%dl
40000c96:	75 e8                	jne    40000c80 <strncmp+0x20>
    if (n == 0)
        return 0;
    else
        return (int) ((unsigned char) *p - (unsigned char) *q);
40000c98:	0f b6 c2             	movzbl %dl,%eax
40000c9b:	29 d8                	sub    %ebx,%eax
}
40000c9d:	5b                   	pop    %ebx
40000c9e:	5e                   	pop    %esi
40000c9f:	c3                   	ret    
...
40000ca3:	5e                   	pop    %esi
40000ca4:	c3                   	ret    
40000ca5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
{
40000cb0:	8b 44 24 04          	mov    0x4(%esp),%eax
40000cb4:	0f b6 4c 24 08       	movzbl 0x8(%esp),%ecx
    for (; *s; s++)
40000cb9:	0f b6 10             	movzbl (%eax),%edx
40000cbc:	84 d2                	test   %dl,%dl
40000cbe:	75 13                	jne    40000cd3 <strchr+0x23>
40000cc0:	eb 1e                	jmp    40000ce0 <strchr+0x30>
40000cc2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000cc8:	0f b6 50 01          	movzbl 0x1(%eax),%edx
40000ccc:	83 c0 01             	add    $0x1,%eax
40000ccf:	84 d2                	test   %dl,%dl
40000cd1:	74 0d                	je     40000ce0 <strchr+0x30>
        if (*s == c)
40000cd3:	38 d1                	cmp    %dl,%cl
40000cd5:	75 f1                	jne    40000cc8 <strchr+0x18>
            return (char *) s;
    return 0;
}
40000cd7:	c3                   	ret    
...
40000cdf:	90                   	nop
    return 0;
40000ce0:	31 c0                	xor    %eax,%eax
}
40000ce2:	c3                   	ret    
40000ce3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
{
40000cf0:	53                   	push   %ebx
40000cf1:	8b 44 24 08          	mov    0x8(%esp),%eax
40000cf5:	8b 54 24 0c          	mov    0xc(%esp),%edx
    for (; *s; s++)
40000cf9:	0f b6 18             	movzbl (%eax),%ebx
        if (*s == c)
40000cfc:	38 d3                	cmp    %dl,%bl
40000cfe:	74 1f                	je     40000d1f <strfind+0x2f>
40000d00:	89 d1                	mov    %edx,%ecx
40000d02:	84 db                	test   %bl,%bl
40000d04:	75 0e                	jne    40000d14 <strfind+0x24>
40000d06:	eb 17                	jmp    40000d1f <strfind+0x2f>
40000d08:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000d0f:	90                   	nop
40000d10:	84 d2                	test   %dl,%dl
40000d12:	74 0b                	je     40000d1f <strfind+0x2f>
    for (; *s; s++)
40000d14:	0f b6 50 01          	movzbl 0x1(%eax),%edx
40000d18:	83 c0 01             	add    $0x1,%eax
        if (*s == c)
40000d1b:	38 ca                	cmp    %cl,%dl
...
40000d31:	57                   	push   %edi
40000d32:	56                   	push   %esi
40000d33:	53                   	push   %ebx
40000d34:	8b 54 24 14          	mov    0x14(%esp),%edx
40000d38:	8b 74 24 18          	mov    0x18(%esp),%esi
40000d3c:	8b 5c 24 1c          	mov    0x1c(%esp),%ebx
    int neg = 0;
    long val = 0;

    // gobble initial whitespace
    while (*s == ' ' || *s == '\t')
40000d40:	0f b6 02             	movzbl (%edx),%eax
40000d43:	3c 09                	cmp    $0x9,%al
40000d45:	74 09                	je     40000d50 <strtol+0x20>
40000d47:	3c 20                	cmp    $0x20,%al
40000d49:	75 14                	jne    40000d5f <strtol+0x2f>
40000d4b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000d4f:	90                   	nop
...
40000d61:	0f 84 99 00 00 00    	je     40000e00 <strtol+0xd0>
    int neg = 0;
40000d67:	31 ff                	xor    %edi,%edi
        s++;
    else if (*s == '-')
40000d69:	3c 2d                	cmp    $0x2d,%al
40000d6b:	0f 84 7f 00 00 00    	je     40000df0 <strtol+0xc0>
        s++, neg = 1;

    // hex or octal base prefix
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
40000d71:	0f b6 2a             	movzbl (%edx),%ebp
40000d74:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
40000d7a:	75 13                	jne    40000d8f <strtol+0x5f>
40000d7c:	89 e8                	mov    %ebp,%eax
40000d7e:	3c 30                	cmp    $0x30,%al
40000d80:	0f 84 8a 00 00 00    	je     40000e10 <strtol+0xe0>
        s += 2, base = 16;
    else if (base == 0 && s[0] == '0')
40000d86:	85 db                	test   %ebx,%ebx
40000d88:	75 05                	jne    40000d8f <strtol+0x5f>
        s++, base = 8;
    else if (base == 0)
        base = 10;
40000d8a:	bb 0a 00 00 00       	mov    $0xa,%ebx
40000d8f:	31 c9                	xor    %ecx,%ecx
40000d91:	eb 22                	jmp    40000db5 <strtol+0x85>
40000d93:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000d97:	90                   	nop
    while (1) {
        int dig;
...
40000d98:	8d 45 9f             	lea    -0x61(%ebp),%eax
40000d9b:	3c 19                	cmp    $0x19,%al
40000d9d:	77 41                	ja     40000de0 <strtol+0xb0>
            dig = *s - 'a' + 10;
40000d9f:	8d 45 a9             	lea    -0x57(%ebp),%eax
40000da2:	0f be c0             	movsbl %al,%eax
        else if (*s >= 'A' && *s <= 'Z')
            dig = *s - 'A' + 10;
        else
            break;
        if (dig >= base)
40000da5:	39 d8                	cmp    %ebx,%eax
40000da7:	7d 1a                	jge    40000dc3 <strtol+0x93>
            break;
        s++, val = (val * base) + dig;
40000da9:	0f af cb             	imul   %ebx,%ecx
        if (*s >= '0' && *s <= '9')
40000dac:	0f b6 6a 01          	movzbl 0x1(%edx),%ebp
        s++, val = (val * base) + dig;
40000db0:	83 c2 01             	add    $0x1,%edx
40000db3:	01 c1                	add    %eax,%ecx
        if (*s >= '0' && *s <= '9')
40000db5:	8d 45 d0             	lea    -0x30(%ebp),%eax
40000db8:	3c 09                	cmp    $0x9,%al
40000dba:	77 dc                	ja     40000d98 <strtol+0x68>
            dig = *s - 'A' + 10;
40000dbc:	0f be c0             	movsbl %al,%eax
        if (dig >= base)
40000dbf:	39 d8                	cmp    %ebx,%eax
40000dc1:	7c e6                	jl     40000da9 <strtol+0x79>
        // we don't properly detect overflow!
    }

    if (endptr)
40000dc3:	85 f6                	test   %esi,%esi
40000dc5:	74 02                	je     40000dc9 <strtol+0x99>
        *endptr = (char *) s;
40000dc7:	89 16                	mov    %edx,(%esi)
    return (neg ? -val : val);
40000dc9:	89 c8                	mov    %ecx,%eax
}
40000dcb:	5b                   	pop    %ebx
40000dcc:	5e                   	pop    %esi
    return (neg ? -val : val);
40000dcd:	f7 d8                	neg    %eax
40000dcf:	85 ff                	test   %edi,%edi
}
40000dd1:	5f                   	pop    %edi
40000dd2:	5d                   	pop    %ebp
    return (neg ? -val : val);
40000dd3:	0f 45 c8             	cmovne %eax,%ecx
}
40000dd6:	89 c8                	mov    %ecx,%eax
40000dd8:	c3                   	ret    
40000dd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        else if (*s >= 'A' && *s <= 'Z')
40000de0:	8d 45 bf             	lea    -0x41(%ebp),%eax
40000de3:	3c 19                	cmp    $0x19,%al
40000de5:	77 dc                	ja     40000dc3 <strtol+0x93>
            dig = *s - 'A' + 10;
40000de7:	8d 45 c9             	lea    -0x37(%ebp),%eax
40000dea:	0f be c0             	movsbl %al,%eax
40000ded:	eb d0                	jmp    40000dbf <strtol+0x8f>
40000def:	90                   	nop
        s++, neg = 1;
40000df0:	83 c2 01             	add    $0x1,%edx
40000df3:	bf 01 00 00 00       	mov    $0x1,%edi
40000df8:	e9 74 ff ff ff       	jmp    40000d71 <strtol+0x41>
40000dfd:	8d 76 00             	lea    0x0(%esi),%esi
        s++;
40000e00:	83 c2 01             	add    $0x1,%edx
    int neg = 0;
40000e03:	31 ff                	xor    %edi,%edi
40000e05:	e9 67 ff ff ff       	jmp    40000d71 <strtol+0x41>
40000e0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
40000e10:	0f b6 42 01          	movzbl 0x1(%edx),%eax
40000e14:	3c 78                	cmp    $0x78,%al
40000e16:	74 17                	je     40000e2f <strtol+0xff>
    else if (base == 0 && s[0] == '0')
40000e18:	85 db                	test   %ebx,%ebx
40000e1a:	0f 85 6f ff ff ff    	jne    40000d8f <strtol+0x5f>
        s++, base = 8;
40000e20:	83 c2 01             	add    $0x1,%edx
40000e23:	89 c5                	mov    %eax,%ebp
40000e25:	bb 08 00 00 00       	mov    $0x8,%ebx
40000e2a:	e9 60 ff ff ff       	jmp    40000d8f <strtol+0x5f>
        if (*s >= '0' && *s <= '9')
40000e2f:	0f b6 6a 02          	movzbl 0x2(%edx),%ebp
        s += 2, base = 16;
40000e33:	bb 10 00 00 00       	mov    $0x10,%ebx
40000e38:	83 c2 02             	add    $0x2,%edx
40000e3b:	e9 4f ff ff ff       	jmp    40000d8f <strtol+0x5f>
...
40000e42:	53                   	push   %ebx
40000e43:	8b 4c 24 18          	mov    0x18(%esp),%ecx
40000e47:	8b 7c 24 10          	mov    0x10(%esp),%edi
    if (n == 0)
40000e4b:	85 c9                	test   %ecx,%ecx
40000e4d:	74 28                	je     40000e77 <memset+0x37>
        return v;
    if ((int) v % 4 == 0 && n % 4 == 0) {
40000e4f:	89 f8                	mov    %edi,%eax
40000e51:	09 c8                	or     %ecx,%eax
40000e53:	a8 03                	test   $0x3,%al
40000e55:	75 29                	jne    40000e80 <memset+0x40>
        c &= 0xFF;
40000e57:	0f b6 5c 24 14       	movzbl 0x14(%esp),%ebx
        c = (c << 24) | (c << 16) | (c << 8) | c;
        asm volatile ("cld; rep stosl\n"
                      :: "D" (v), "a" (c), "c" (n / 4)
40000e5c:	c1 e9 02             	shr    $0x2,%ecx
        c = (c << 24) | (c << 16) | (c << 8) | c;
40000e5f:	89 da                	mov    %ebx,%edx
40000e61:	89 de                	mov    %ebx,%esi
40000e63:	89 d8                	mov    %ebx,%eax
40000e65:	c1 e2 18             	shl    $0x18,%edx
40000e68:	c1 e6 10             	shl    $0x10,%esi
40000e6b:	09 f2                	or     %esi,%edx
40000e6d:	c1 e0 08             	shl    $0x8,%eax
40000e70:	09 da                	or     %ebx,%edx
40000e72:	09 d0                	or     %edx,%eax
        asm volatile ("cld; rep stosl\n"
40000e74:	fc                   	cld    
40000e75:	f3 ab                	rep stos %eax,%es:(%edi)
    } else
...
40000e7b:	5f                   	pop    %edi
40000e7c:	c3                   	ret    
40000e7d:	8d 76 00             	lea    0x0(%esi),%esi
        asm volatile ("cld; rep stosb\n"
40000e80:	8b 44 24 14          	mov    0x14(%esp),%eax
40000e84:	fc                   	cld    
40000e85:	f3 aa                	rep stos %al,%es:(%edi)
}
...
40000e92:	8b 44 24 0c          	mov    0xc(%esp),%eax
40000e96:	8b 74 24 10          	mov    0x10(%esp),%esi
40000e9a:	8b 4c 24 14          	mov    0x14(%esp),%ecx
    const char *s;
    char *d;
    ...
    d = dst;
    if (s < d && s + n > d) {
40000e9e:	39 c6                	cmp    %eax,%esi
40000ea0:	73 26                	jae    40000ec8 <memmove+0x38>
40000ea2:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
40000ea5:	39 c2                	cmp    %eax,%edx
40000ea7:	76 1f                	jbe    40000ec8 <memmove+0x38>
        s += n;
        d += n;
40000ea9:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
        if ((int) s % 4 == 0 && (int) d % 4 == 0 && n % 4 == 0)
40000eac:	89 d6                	mov    %edx,%esi
40000eae:	09 fe                	or     %edi,%esi
40000eb0:	09 ce                	or     %ecx,%esi
40000eb2:	83 e6 03             	and    $0x3,%esi
40000eb5:	74 39                	je     40000ef0 <memmove+0x60>
            ...
            asm volatile ("std; rep movsb\n"
                          :: "D" (d - 1), "S" (s - 1), "c" (n)
40000eb7:	83 ef 01             	sub    $0x1,%edi
40000eba:	8d 72 ff             	lea    -0x1(%edx),%esi
            asm volatile ("std; rep movsb\n"
40000ebd:	fd                   	std    
...
40000ec2:	5f                   	pop    %edi
40000ec3:	c3                   	ret    
40000ec4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if ((int) s % 4 == 0 && (int) d % 4 == 0 && n % 4 == 0)
40000ec8:	89 f2                	mov    %esi,%edx
40000eca:	09 c2                	or     %eax,%edx
40000ecc:	09 ca                	or     %ecx,%edx
40000ece:	83 e2 03             	and    $0x3,%edx
40000ed1:	74 0d                	je     40000ee0 <memmove+0x50>
            asm volatile ("cld; rep movsb\n"
40000ed3:	89 c7                	mov    %eax,%edi
40000ed5:	fc                   	cld    
40000ed6:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
}
40000ed8:	5e                   	pop    %esi
40000ed9:	5f                   	pop    %edi
40000eda:	c3                   	ret    
40000edb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000edf:	90                   	nop
                          :: "D" (d), "S" (s), "c" (n / 4)
40000ee0:	c1 e9 02             	shr    $0x2,%ecx
            asm volatile ("cld; rep movsl\n"
40000ee3:	89 c7                	mov    %eax,%edi
40000ee5:	fc                   	cld    
40000ee6:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
40000ee8:	eb ee                	jmp    40000ed8 <memmove+0x48>
40000eea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
                          :: "D" (d - 4), "S" (s - 4), "c" (n / 4)
40000ef0:	83 ef 04             	sub    $0x4,%edi
40000ef3:	8d 72 fc             	lea    -0x4(%edx),%esi
40000ef6:	c1 e9 02             	shr    $0x2,%ecx
            asm volatile ("std; rep movsl\n"
40000ef9:	fd                   	std    
40000efa:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
40000efc:	eb c2                	jmp    40000ec0 <memmove+0x30>
40000efe:	66 90                	xchg   %ax,%ax
...
40000f00:	eb 8e                	jmp    40000e90 <memmove>
40000f02:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
{
40000f10:	56                   	push   %esi
40000f11:	53                   	push   %ebx
40000f12:	8b 74 24 14          	mov    0x14(%esp),%esi
40000f16:	8b 54 24 0c          	mov    0xc(%esp),%edx
40000f1a:	8b 44 24 10          	mov    0x10(%esp),%eax
    const uint8_t *s1 = (const uint8_t *) v1;
    const uint8_t *s2 = (const uint8_t *) v2;

    while (n-- > 0) {
40000f1e:	85 f6                	test   %esi,%esi
40000f20:	74 2e                	je     40000f50 <memcmp+0x40>
40000f22:	01 c6                	add    %eax,%esi
40000f24:	eb 14                	jmp    40000f3a <memcmp+0x2a>
40000f26:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000f2d:	8d 76 00             	lea    0x0(%esi),%esi
        if (*s1 != *s2)
            return (int) *s1 - (int) *s2;
        s1++, s2++;
40000f30:	83 c0 01             	add    $0x1,%eax
40000f33:	83 c2 01             	add    $0x1,%edx
    while (n-- > 0) {
40000f36:	39 f0                	cmp    %esi,%eax
40000f38:	74 16                	je     40000f50 <memcmp+0x40>
        if (*s1 != *s2)
40000f3a:	0f b6 0a             	movzbl (%edx),%ecx
40000f3d:	0f b6 18             	movzbl (%eax),%ebx
40000f40:	38 d9                	cmp    %bl,%cl
40000f42:	74 ec                	je     40000f30 <memcmp+0x20>
            return (int) *s1 - (int) *s2;
40000f44:	0f b6 c1             	movzbl %cl,%eax
40000f47:	29 d8                	sub    %ebx,%eax
    }
...
40000f4a:	5e                   	pop    %esi
40000f4b:	c3                   	ret    
40000f4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
...
40000f53:	5e                   	pop    %esi
40000f54:	c3                   	ret    
40000f55:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
40000f64:	8b 54 24 0c          	mov    0xc(%esp),%edx
40000f68:	01 c2                	add    %eax,%edx
    for (; s < ends; s++)
40000f6a:	39 d0                	cmp    %edx,%eax
40000f6c:	73 1a                	jae    40000f88 <memchr+0x28>
        if (*(const unsigned char *) s == (unsigned char) c)
40000f6e:	0f b6 4c 24 08       	movzbl 0x8(%esp),%ecx
40000f73:	eb 0a                	jmp    40000f7f <memchr+0x1f>
40000f75:	8d 76 00             	lea    0x0(%esi),%esi
    for (; s < ends; s++)
40000f78:	83 c0 01             	add    $0x1,%eax
40000f7b:	39 c2                	cmp    %eax,%edx
40000f7d:	74 09                	je     40000f88 <memchr+0x28>
        if (*(const unsigned char *) s == (unsigned char) c)
40000f7f:	38 08                	cmp    %cl,(%eax)
40000f81:	75 f5                	jne    40000f78 <memchr+0x18>
            return (void *) s;
    return NULL;
}
40000f83:	c3                   	ret    
...
{
40000f90:	57                   	push   %edi
40000f91:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
40000f95:	8b 7c 24 08          	mov    0x8(%esp),%edi
    if (n == 0)
40000f99:	85 c9                	test   %ecx,%ecx
40000f9b:	74 0f                	je     40000fac <memzero+0x1c>
    if ((int) v % 4 == 0 && n % 4 == 0) {
40000f9d:	89 f8                	mov    %edi,%eax
40000f9f:	09 c8                	or     %ecx,%eax
40000fa1:	83 e0 03             	and    $0x3,%eax
40000fa4:	75 0a                	jne    40000fb0 <memzero+0x20>
                      :: "D" (v), "a" (c), "c" (n / 4)
40000fa6:	c1 e9 02             	shr    $0x2,%ecx
        asm volatile ("cld; rep stosl\n"
40000fa9:	fc                   	cld    
40000faa:	f3 ab                	rep stos %eax,%es:(%edi)
    return memset(v, 0, n);
}
40000fac:	89 f8                	mov    %edi,%eax
40000fae:	5f                   	pop    %edi
40000faf:	c3                   	ret    
        asm volatile ("cld; rep stosb\n"
40000fb0:	31 c0                	xor    %eax,%eax
40000fb2:	fc                   	cld    
40000fb3:	f3 aa                	rep stos %al,%es:(%edi)
}
40000fb5:	89 f8                	mov    %edi,%eax
40000fb7:	5f                   	pop    %edi
40000fb8:	c3                   	ret    
40000fb9:	66 90                	xchg   %ax,%ax
40000fbb:	66 90                	xchg   %ax,%ax
40000fbd:	66 90                	xchg   %ax,%ax
40000fbf:	90                   	nop

40000fc0 <__udivdi3>:
40000fc0:	f3 0f 1e fb          	endbr32 
40000fc4:	55                   	push   %ebp
40000fc5:	57                   	push   %edi
40000fc6:	56                   	push   %esi
40000fc7:	53                   	push   %ebx
40000fc8:	83 ec 1c             	sub    $0x1c,%esp
40000fcb:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000fcf:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000fd3:	8b 74 24 34          	mov    0x34(%esp),%esi
40000fd7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000fdb:	85 c0                	test   %eax,%eax
40000fdd:	75 19                	jne    40000ff8 <__udivdi3+0x38>
40000fdf:	39 f3                	cmp    %esi,%ebx
40000fe1:	76 4d                	jbe    40001030 <__udivdi3+0x70>
40000fe3:	31 ff                	xor    %edi,%edi
40000fe5:	89 e8                	mov    %ebp,%eax
40000fe7:	89 f2                	mov    %esi,%edx
40000fe9:	f7 f3                	div    %ebx
40000feb:	89 fa                	mov    %edi,%edx
40000fed:	83 c4 1c             	add    $0x1c,%esp
40000ff0:	5b                   	pop    %ebx
40000ff1:	5e                   	pop    %esi
40000ff2:	5f                   	pop    %edi
40000ff3:	5d                   	pop    %ebp
40000ff4:	c3                   	ret    
40000ff5:	8d 76 00             	lea    0x0(%esi),%esi
40000ff8:	39 f0                	cmp    %esi,%eax
40000ffa:	76 14                	jbe    40001010 <__udivdi3+0x50>
40000ffc:	31 ff                	xor    %edi,%edi
40000ffe:	31 c0                	xor    %eax,%eax
40001000:	89 fa                	mov    %edi,%edx
40001002:	83 c4 1c             	add    $0x1c,%esp
40001005:	5b                   	pop    %ebx
40001006:	5e                   	pop    %esi
40001007:	5f                   	pop    %edi
40001008:	5d                   	pop    %ebp
...
40001010:	0f bd f8             	bsr    %eax,%edi
40001013:	83 f7 1f             	xor    $0x1f,%edi
40001016:	75 48                	jne    40001060 <__udivdi3+0xa0>
40001018:	39 f0                	cmp    %esi,%eax
4000101a:	72 06                	jb     40001022 <__udivdi3+0x62>
4000101c:	31 c0                	xor    %eax,%eax
4000101e:	39 eb                	cmp    %ebp,%ebx
40001020:	77 de                	ja     40001000 <__udivdi3+0x40>
40001022:	b8 01 00 00 00       	mov    $0x1,%eax
40001027:	eb d7                	jmp    40001000 <__udivdi3+0x40>
40001029:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40001030:	89 d9                	mov    %ebx,%ecx
40001032:	85 db                	test   %ebx,%ebx
40001034:	75 0b                	jne    40001041 <__udivdi3+0x81>
40001036:	b8 01 00 00 00       	mov    $0x1,%eax
4000103b:	31 d2                	xor    %edx,%edx
4000103d:	f7 f3                	div    %ebx
4000103f:	89 c1                	mov    %eax,%ecx
40001041:	31 d2                	xor    %edx,%edx
40001043:	89 f0                	mov    %esi,%eax
40001045:	f7 f1                	div    %ecx
40001047:	89 c6                	mov    %eax,%esi
40001049:	89 e8                	mov    %ebp,%eax
4000104b:	89 f7                	mov    %esi,%edi
4000104d:	f7 f1                	div    %ecx
4000104f:	89 fa                	mov    %edi,%edx
40001051:	83 c4 1c             	add    $0x1c,%esp
40001054:	5b                   	pop    %ebx
40001055:	5e                   	pop    %esi
40001056:	5f                   	pop    %edi
40001057:	5d                   	pop    %ebp
...
40001060:	89 f9                	mov    %edi,%ecx
40001062:	ba 20 00 00 00       	mov    $0x20,%edx
40001067:	29 fa                	sub    %edi,%edx
40001069:	d3 e0                	shl    %cl,%eax
4000106b:	89 44 24 08          	mov    %eax,0x8(%esp)
4000106f:	89 d1                	mov    %edx,%ecx
40001071:	89 d8                	mov    %ebx,%eax
40001073:	d3 e8                	shr    %cl,%eax
40001075:	8b 4c 24 08          	mov    0x8(%esp),%ecx
40001079:	09 c1                	or     %eax,%ecx
4000107b:	89 f0                	mov    %esi,%eax
4000107d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40001081:	89 f9                	mov    %edi,%ecx
40001083:	d3 e3                	shl    %cl,%ebx
40001085:	89 d1                	mov    %edx,%ecx
40001087:	d3 e8                	shr    %cl,%eax
40001089:	89 f9                	mov    %edi,%ecx
4000108b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
4000108f:	89 eb                	mov    %ebp,%ebx
40001091:	d3 e6                	shl    %cl,%esi
40001093:	89 d1                	mov    %edx,%ecx
40001095:	d3 eb                	shr    %cl,%ebx
40001097:	09 f3                	or     %esi,%ebx
40001099:	89 c6                	mov    %eax,%esi
4000109b:	89 f2                	mov    %esi,%edx
4000109d:	89 d8                	mov    %ebx,%eax
4000109f:	f7 74 24 08          	divl   0x8(%esp)
400010a3:	89 d6                	mov    %edx,%esi
400010a5:	89 c3                	mov    %eax,%ebx
400010a7:	f7 64 24 0c          	mull   0xc(%esp)
400010ab:	39 d6                	cmp    %edx,%esi
400010ad:	72 19                	jb     400010c8 <__udivdi3+0x108>
400010af:	89 f9                	mov    %edi,%ecx
400010b1:	d3 e5                	shl    %cl,%ebp
400010b3:	39 c5                	cmp    %eax,%ebp
400010b5:	73 04                	jae    400010bb <__udivdi3+0xfb>
400010b7:	39 d6                	cmp    %edx,%esi
400010b9:	74 0d                	je     400010c8 <__udivdi3+0x108>
400010bb:	89 d8                	mov    %ebx,%eax
400010bd:	31 ff                	xor    %edi,%edi
400010bf:	e9 3c ff ff ff       	jmp    40001000 <__udivdi3+0x40>
400010c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
400010c8:	8d 43 ff             	lea    -0x1(%ebx),%eax
400010cb:	31 ff                	xor    %edi,%edi
400010cd:	e9 2e ff ff ff       	jmp    40001000 <__udivdi3+0x40>
...
400010eb:	8b 74 24 30          	mov    0x30(%esp),%esi
400010ef:	8b 5c 24 34          	mov    0x34(%esp),%ebx
400010f3:	8b 7c 24 3c          	mov    0x3c(%esp),%edi
400010f7:	8b 6c 24 38          	mov    0x38(%esp),%ebp
400010fb:	89 f0                	mov    %esi,%eax
400010fd:	89 da                	mov    %ebx,%edx
400010ff:	85 ff                	test   %edi,%edi
40001101:	75 15                	jne    40001118 <__umoddi3+0x38>
40001103:	39 dd                	cmp    %ebx,%ebp
40001105:	76 39                	jbe    40001140 <__umoddi3+0x60>
40001107:	f7 f5                	div    %ebp
40001109:	89 d0                	mov    %edx,%eax
...
40001118:	39 df                	cmp    %ebx,%edi
4000111a:	77 f1                	ja     4000110d <__umoddi3+0x2d>
4000111c:	0f bd cf             	bsr    %edi,%ecx
4000111f:	83 f1 1f             	xor    $0x1f,%ecx
40001122:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40001126:	75 40                	jne    40001168 <__umoddi3+0x88>
40001128:	39 df                	cmp    %ebx,%edi
4000112a:	72 04                	jb     40001130 <__umoddi3+0x50>
4000112c:	39 f5                	cmp    %esi,%ebp
4000112e:	77 dd                	ja     4000110d <__umoddi3+0x2d>
40001130:	89 da                	mov    %ebx,%edx
40001132:	89 f0                	mov    %esi,%eax
40001134:	29 e8                	sub    %ebp,%eax
40001136:	19 fa                	sbb    %edi,%edx
40001138:	eb d3                	jmp    4000110d <__umoddi3+0x2d>
4000113a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40001140:	89 e9                	mov    %ebp,%ecx
40001142:	85 ed                	test   %ebp,%ebp
40001144:	75 0b                	jne    40001151 <__umoddi3+0x71>
40001146:	b8 01 00 00 00       	mov    $0x1,%eax
4000114b:	31 d2                	xor    %edx,%edx
4000114d:	f7 f5                	div    %ebp
4000114f:	89 c1                	mov    %eax,%ecx
40001151:	89 d8                	mov    %ebx,%eax
40001153:	31 d2                	xor    %edx,%edx
40001155:	f7 f1                	div    %ecx
40001157:	89 f0                	mov    %esi,%eax
40001159:	f7 f1                	div    %ecx
4000115b:	89 d0                	mov    %edx,%eax
4000115d:	31 d2                	xor    %edx,%edx
4000115f:	eb ac                	jmp    4000110d <__umoddi3+0x2d>
40001161:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40001168:	8b 44 24 04          	mov    0x4(%esp),%eax
4000116c:	ba 20 00 00 00       	mov    $0x20,%edx
40001171:	29 c2                	sub    %eax,%edx
40001173:	89 c1                	mov    %eax,%ecx
40001175:	89 e8                	mov    %ebp,%eax
40001177:	d3 e7                	shl    %cl,%edi
40001179:	89 d1                	mov    %edx,%ecx
4000117b:	89 54 24 0c          	mov    %edx,0xc(%esp)
4000117f:	d3 e8                	shr    %cl,%eax
40001181:	89 c1                	mov    %eax,%ecx
40001183:	8b 44 24 04          	mov    0x4(%esp),%eax
40001187:	09 f9                	or     %edi,%ecx
40001189:	89 df                	mov    %ebx,%edi
4000118b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
4000118f:	89 c1                	mov    %eax,%ecx
40001191:	d3 e5                	shl    %cl,%ebp
40001193:	89 d1                	mov    %edx,%ecx
40001195:	d3 ef                	shr    %cl,%edi
40001197:	89 c1                	mov    %eax,%ecx
40001199:	89 f0                	mov    %esi,%eax
4000119b:	d3 e3                	shl    %cl,%ebx
4000119d:	89 d1                	mov    %edx,%ecx
4000119f:	89 fa                	mov    %edi,%edx
400011a1:	d3 e8                	shr    %cl,%eax
400011a3:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
400011a8:	09 d8                	or     %ebx,%eax
400011aa:	f7 74 24 08          	divl   0x8(%esp)
400011ae:	89 d3                	mov    %edx,%ebx
400011b0:	d3 e6                	shl    %cl,%esi
400011b2:	f7 e5                	mul    %ebp
400011b4:	89 c7                	mov    %eax,%edi
400011b6:	89 d1                	mov    %edx,%ecx
400011b8:	39 d3                	cmp    %edx,%ebx
400011ba:	72 06                	jb     400011c2 <__umoddi3+0xe2>
400011bc:	75 0e                	jne    400011cc <__umoddi3+0xec>
400011be:	39 c6                	cmp    %eax,%esi
400011c0:	73 0a                	jae    400011cc <__umoddi3+0xec>
400011c2:	29 e8                	sub    %ebp,%eax
400011c4:	1b 54 24 08          	sbb    0x8(%esp),%edx
400011c8:	89 d1                	mov    %edx,%ecx
400011ca:	89 c7                	mov    %eax,%edi
400011cc:	89 f5                	mov    %esi,%ebp
400011ce:	8b 74 24 04          	mov    0x4(%esp),%esi
400011d2:	29 fd                	sub    %edi,%ebp
400011d4:	19 cb                	sbb    %ecx,%ebx
400011d6:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
400011db:	89 d8                	mov    %ebx,%eax
400011dd:	d3 e0                	shl    %cl,%eax
400011df:	89 f1                	mov    %esi,%ecx
400011e1:	d3 ed                	shr    %cl,%ebp
400011e3:	d3 eb                	shr    %cl,%ebx
400011e5:	09 e8                	or     %ebp,%eax
400011e7:	89 da                	mov    %ebx,%edx
400011e9:	83 c4 1c             	add    $0x1c,%esp
400011ec:	5b                   	pop    %ebx
400011ed:	5e                   	pop    %esi
400011ee:	5f                   	pop    %edi
400011ef:	5d                   	pop    %ebp
